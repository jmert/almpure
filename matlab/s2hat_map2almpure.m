function alms=s2hat_map2almpure(map,apmask,lmax,mmax,qwghts)
% alms=s2hat_map2almpure(map,apmask,lmax,mmax)
%
...
%
  ...
  % itself.
  alms = s2hat_map2almpure_c(map, apmask, int32(lmax), int32(mmax), qwghts);
end
